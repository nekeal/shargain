 ...
 */
export const getAvailableFields = <ThrowOnError extends boolean = true>(options: Options<GetAvailableFieldsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetAvailableFieldsResponses, GetAvailableFieldsErrors, ThrowOnError>({
        url: '/api/public/urls/{url_id}/available-fields',
        ...options
    });
};
 ...
 */
export const listTargets = <ThrowOnError extends boolean = true>(options?: Options<ListTargetsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<ListTargetsResponses, unknown, ThrowOnError>({
 ...
 * Get Quota Status
 */
export const getQuotaStatus = <ThrowOnError extends boolean = true>(options?: Options<GetQuotaStatusData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetQuotaStatusResponses, unknown, ThrowOnError>({
...
/**
 * Update Scraping Url View
 * Update an existing scraping URL.
 */
export const updateScrapingUrl = <ThrowOnError extends boolean = true>(options: Options<UpdateScrapingUrlData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<UpdateScrapingUrlResponses, UpdateScrapingUrlErrors, ThrowOnError>({
        url: '/api/public/targets/{target_id}/urls/{url_id}',
        ...options,
        headers: {
            'Content-Type': 'application/json',
