 ...
 */
export type AvailableFieldSchema = {
    /**
     * Name
     */
    name: string;
     ...
     * Operators
     */
    operators: Array<FieldOperatorSchema>;
};
 ...
 * FieldOperatorSchema
 */
export type FieldOperatorSchema = {
    /**
     * Value
     */
    value: string;
 ...
 */
export type FiltersConfigSchema = {
    /**
     * Rulegroups
     */
 ...
 */
export type NotificationFieldsSchema = {
    /**
     * Fields
     */
    fields?: Array<string>;
 ...
 */
export type RuleGroupSchema = {
    /**
     * Rules
     */
    rules: Array<FilterRuleSchema>;
    /**
     * Logic
     */
    logic?: string;
...
export type ScrapingUrlResponse = {
    ...
    notificationFields?: NotificationFieldsSchema | null;
};
...
export type GetAvailableFieldsData = {
    body?: never;
    path: {
        /**
         * Url Id
...
export type GetAvailableFieldsErrors = {
    /**
     * Unauthorized
     */
    401: ErrorSchema;
...
export type GetAvailableFieldsError = GetAvailableFieldsErrors[keyof GetAvailableFieldsErrors];

export type GetAvailableFieldsResponses = {
    /**
     * OK
     */
...
export type GetAvailableFieldsResponse = GetAvailableFieldsResponses[keyof GetAvailableFieldsResponses];
