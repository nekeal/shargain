    ...
    <>
      ...
      <div className="bg-gradient-to-b from-violet-50 via-purple-50 to-indigo-100 dark:from-violet-950/50 dark:via-purple-950/30 dark:to-background">
        <div className="container mx-auto px-4 text-center py-24">
          <h1 className="text-4xl md:text-6xl font-bold tracking-tighter text-gray-900 dark:text-white">Never Miss a Deal Again</h1>
          <p className="text-lg md:text-xl text-gray-700 dark:text-gray-300 mt-4 max-w-3xl mx-auto">Get instant notifications when new offers appear on your favorite websites.</p>
          <div className="mt-8">
            <Button asChild size="lg" className="bg-gradient-to-r from-violet-600 to-indigo-700 hover:from-violet-700 hover:to-indigo-800 shadow-lg hover:shadow-xl transition-all duration-300">
              <Link to="/auth/signup">Sign Up for Beta</Link>
            </Button>
          </div>
        </div>
      </div>
      <div className="container mx-auto px-4 py-24">
        <h2 className="text-3xl md:text-4xl font-bold tracking-tighter text-center text-gray-900 dark:text-white">How it Works</h2>
        <p className="text-lg md:text-xl text-gray-700 dark:text-gray-300 mt-4 max-w-3xl mx-auto text-center">Get started in just three simple steps</p>
        <div className="grid md:grid-cols-3 gap-8 mt-12">
          <div className="text-center bg-white dark:bg-gray-800/50 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-white">Add Your URLs</h3>
            <p className="text-gray-700 dark:text-gray-300 mt-2">Simply paste the URLs of websites you want to monitor for new offers.</p>
          </div>
          <div className="text-center bg-white dark:bg-gray-800/50 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-white">Configure Alerts</h3>
            <p className="text-gray-700 dark:text-gray-300 mt-2">Choose how you want to be notified - Telegram, email, or both.</p>
          </div>
          <div className="text-center bg-white dark:bg-gray-800/50 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-white">Get Notified</h3>
            <p className="text-gray-700 dark:text-gray-300 mt-2">Sit back and relax. We'll monitor your sites 24/7 and alert you instantly.</p>
          </div>
        </div>
      </div>
      <div className="bg-gradient-to-r from-violet-100 to-indigo-100 dark:from-violet-900/30 dark:to-indigo-900/30 py-24">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold tracking-tighter text-center text-gray-900 dark:text-white">Pricing</h2>
          <p className="text-lg md:text-xl text-gray-700 dark:text-gray-300 mt-4 max-w-3xl mx-auto text-center">The service is free during the closed beta.</p>
          <div className="max-w-md mx-auto mt-12 bg-white dark:bg-gray-800/50 rounded-2xl shadow-lg p-8 border border-violet-200 dark:border-violet-800">
            <div className="text-center">
              ...
              <div className="mt-4">
                <span className="text-4xl font-bold text-violet-600 dark:text-violet-400">Free</span>
                <span className="text-gray-700 dark:text-gray-300"> during beta</span>
              </div>
